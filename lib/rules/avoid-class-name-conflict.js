...
const addedTypes = require("../util/addedTypes") // from TSJS-lib-generator/inputfiles/addedTypes
const overridingTypes = require("../util/overridingTypes")
const { natives } = require("../util/natives")
// https://github.com/kgoe/node-tester/blob/9155c762eee8c4f2429a0c5ec9a46e43c2d0fe8d/test-disabled/map-properties.js
const chromeGlobals = require("../util/chromeGlobals")
